...
const ComponentArray default_components = {
    ...
    MakeComponent(PICKUP_COMPONENT,         PHYSICS_COMPONENT,  { PICKUP_TYPE_ATTRIBUTE, AMOUNT_ATTRIBUTE } ),
    MakeComponent(ANIMATION_COMPONENT,      SPRITE_COMPONENT,   { TRIGGER_NAME_ATTRIBUTE, ANIMATION_ATTRIBUTE } ),
};
