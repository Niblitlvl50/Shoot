...
void PhysicsStatsElement::EntityDraw(mono::IRenderer& renderer) const
{
    ...
    renderer.RenderText(shared::FontId::PIXELETTE_MEGA, text_1, math::ZeroVec, false, m_color);
    renderer.RenderText(shared::FontId::PIXELETTE_MEGA, text_2, math::Vector(0.0f, -5.0f), false, m_color);
    renderer.RenderText(shared::FontId::PIXELETTE_MEGA, text_3, math::Vector(0.0f, -10.0f), false, m_color);
}
