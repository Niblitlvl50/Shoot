...
namespace world
{
    ...
    static const std::array<DefaultAttribute, 24> default_attributes = {{
    ...
    static const uint32_t PATH_FILE_ATTRIBUTE           = default_attributes[5].hash;
    ...
    static const uint32_t FACTION_ATTRIBUTE             = default_attributes[13].hash;
    ...
    static const uint32_t SPRITE_ATTRIBUTE              = default_attributes[19].hash;
    static const uint32_t ANIMATION_ATTRIBUTE           = default_attributes[20].hash;
    static const uint32_t FLIP_VERTICAL_ATTRIBUTE       = default_attributes[21].hash;
    static const uint32_t FLIP_HORIZONTAL_ATTRIBUTE     = default_attributes[22].hash;
    static const uint32_t ENTITY_BEHAVIOUR_ATTRIBUTE    = default_attributes[23].hash;
    ...
    inline const Variant& DefaultAttributeFromHash(uint32_t hash)
    {
        ...
        std::printf("Unable to find default attribute for hash: %u\n", hash);
