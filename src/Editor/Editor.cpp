    ...
    , m_pick_target(nullptr)
{
    ...
    editor::LoadAllMusicTracks("res/configs/sound_config.json");
    editor::LoadAllSounds("res/sound/all_sounds.json");
    editor::LoadAllWeapons("res/configs/weapon_config.json");
...
void Editor::OnLoad(mono::ICamera* camera, mono::IRenderer* renderer)
{
    ...
    draw_funcs[RELAY_TRIGGER_COMPONENT] = editor::DrawRelayTriggerComponentDetails;
