    ...
    , m_system_context(system_context)
{
    ...
    m_bullet_callbacks = {
        ...
        { CACO_PLASMA_HOMING.bullet_hash,std::bind(CacoPlasmaCollision, _1, _2, _3, _4, m_entity_manager, damage_system, physics_system, sprite_system, transform_system) },
        ...
        { LASER_BLASTER.bullet_hash,    std::bind(StandardCollision, _1, _2, _3, _4, m_entity_manager, damage_system, physics_system, sprite_system, transform_system) },
    };
